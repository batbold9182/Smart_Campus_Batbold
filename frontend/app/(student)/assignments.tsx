      ...
      <ScrollView className="flex-1 px-5" contentContainerClassName="pb-5">
        ...
        <View className="mb-4 rounded-xl bg-white p-4 shadow">
          ...
          <Text className="text-[#6b7280]">
            see all the assignments here, submit your work, and check feedback from your instructors. This will include file uploads, text submissions, and a calendar view to keep track of due dates.
          </Text>
        </View>
