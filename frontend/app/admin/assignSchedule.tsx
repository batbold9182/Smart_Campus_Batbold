    ...
    <SafeAreaView className="flex-1 bg-app-bg" edges={["top"]}>
      <ScrollView className="flex-1 px-5" contentContainerClassName="pb-6" showsVerticalScrollIndicator={false}>
        <AppCard className="rounded-2xl border border-app-border-light bg-app-surface p-4 shadow-sm">
          <Text className="text-app-xl font-bold text-app-text">Assign Schedule</Text>
          <Text className="mb-4 mt-1 text-app-sm text-app-muted">
            Link a student to a class schedule or remove an existing assignment.
          </Text>

          <Text className="mb-1 text-app-sm font-semibold text-app-text-secondary">Student</Text>
          <TouchableOpacity
        ...
        <View className="mt-3 rounded-xl bg-app-surface p-4 shadow-sm">
          <Text className="text-app-base font-semibold text-app-text">Quick Tips</Text>
          <Text className="mt-2 text-app-sm text-app-muted">1. Select a student first, then select a schedule slot.</Text>
          <Text className="mt-1 text-app-sm text-app-muted">2. Use unassign when students switch classes.</Text>
        </View>
      </ScrollView>
